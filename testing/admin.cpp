...
void Admin::edit_user()
{
	...
	std::cout << "ДАННЫЕ ПОЛЬЗОВАТЕЛЯ УСПЕШНО ИЗМЕНЕНЫ" << std::endl << std::endl; system("pause");
}
...
void Admin::delete_user()
{
	...
	std::cout << "ПОЛЬЗОВАТЕЛЬ УСПЕШНО УДАЛЁН" << std::endl << std::endl; system("pause");
}
...
void Admin::new_test()
{
	...
	std::cout << "ТЕСТ УСПЕШНО СОЗДАН" << std::endl << std::endl; system("pause");
}
...
void Admin::edit_test()
{
	...
	std::cout << "ТЕСТ НАЙДЕН" << std::endl << std::endl; system("pause");
}
...
void Admin::delete_test()
{
	...
	std::cout << "ТЕСТ УСПЕШНО УДАЛЁН" << std::endl << std::endl; system("pause");
}
