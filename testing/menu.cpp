...
void Menu::menu()
{
	...
	{
		system("cls");
		this->set_color(2, 0); std::cout << "ПРОГРАММА ДЛЯ ПРОХОЖДЕНИЯ ТЕСТИРОВАНИЙ" << std::endl; this->set_color(15, 0);
...
void UserMenu::menu()
{
	...
	{
		system("cls");
		this->set_color(2, 0); std::cout << "ЗДРАВСТВУЙТЕ, " << user->fio << ", ВЫБЕРИТЕ, ЧТО ВЫ ХОТИТЕ СДЕЛАТЬ: " << std::endl; this->set_color(15, 0);
...
void AdminMenu::menu()
{
	...
	{
		system("cls");
		this->set_color(4, 0); std::cout << "ЗДРАВСТВУЙТЕ, " << admin->fio << ", ВЫБЕРИТЕ, ЧТО ВЫ ХОТИТЕ СДЕЛАТЬ: " << std::endl; this->set_color(15, 0);
